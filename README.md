...
The production files total approximately **21 MB**, including **19.0 MB** for 1,343 recordings. The offline app is only **1.89 MB before transfer compression**, including all English translations, all 50 illustrations (0.84 MB), both fonts and the icons. The translations add approximately 17 KB to the compressed download. A typical audio file is 12.5 KB; the largest is 59.3 KB. No speech model or development dependencies are downloaded by learners.
